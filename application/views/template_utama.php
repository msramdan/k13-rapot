        ...
        <footer class="footer">
            <div class="container-fluid">
                <p class="copyright pull-left">
                    <b><?php echo $this->config->item('nama_sekolah'); ?></b> | <a href="https://github.com/akhwan90/rapor2013" target="_blank">Sumber Asli</a> dikembangkan oleh <a target="_blank" href="http://nur-akhwan.web.id/">Nur Akhwan</a> | Disesuaikan untuk SD oleh <a target="_blank" href="https://youtube.com/riduansalim">Ajat Sudrajat</a> 
                </p>
                <p class="copyright pull-right">
                    Waktu proses {elapsed_time} detik. &copy; 2022 
                </p>
            </div>
        </footer>
