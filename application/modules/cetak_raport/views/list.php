                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?php echo base_url().$url."/prestasi_catatan/".$sk['id_siswa']."/".$tasm; ?>" class="btn btn-success btn-sm" style="display:none" target="_blank"><i  class="fa fa-print"></i> Prestasi&Catatan</a>
                                </td>
                            </tr>
                        <?php 
                                $no++;
