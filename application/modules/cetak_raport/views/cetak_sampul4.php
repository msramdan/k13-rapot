...
<body>
	<table>
		<tr>
			<td width="10%">
			<img src="<?php echo base_url(); ?>aset/img/<?php echo ($this->config->item('logo')); ?>.jpg" style="margin-top: 10px; width: 90px; height: 80px">
			</td>
			<td style="text-align: center"><b><?php echo strtoupper($this->config->item('kementerian')); ?><br>
			DINAS PENDIDIKAN DAN KEBUDAYAAN <?php echo strtoupper($this->config->item('kotaataukab')); ?> <?php echo strtoupper($this->config->item('kota_sekolah')); ?><br>
			...
			Telepon : <?php echo strtoupper($this->config->item('telepon_sekolah')); ?> | Website : <?php echo ($this->config->item('web_sekolah')); ?></span>
			</td>
		</tr>
		...
		<tr><td colspan="2">
			...
			<table width="100%">
				...
				<tr><td>10.</td><td>Diterima di Sekolah ini</td><td>:</td><td></td></tr>
				...
				<tr><td>11.</td><td>Sekolah Asal</td><td>:</td><td></td></tr>
				...
				<tr><td>12.</td><td>Orang Tua</td><td>:</td><td></td></tr>
				...
				<tr><td>13.</td><td>Pekerjaan Orang Tua</td><td>:</td><td></td></tr>
				...
				<tr><td>14.</td><td>Wali</td><td>:</td><td></td></tr>
