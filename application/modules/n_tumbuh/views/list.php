<div class="row">
    ...
    <div class="col-md-5">
        <div class="card">
            <div class="header">
                <h4 class="title">Tumbuh Kembang Anak</h4>
            </div>
            <div class="content">
    ...
    <div class="col-md-7">
        <div class="card">
            <div class="header">
                <h4 class="title">Input Nilai Perkembangan</h4>
            </div>
            <div class="content">
...
<script type="text/javascript">
    ...
    function view_kd(id, nama) {
        ...
        if (id == 0) {
            $("#load_nilai").html('<div class="alert alert-warning">Silakan pilih aspek di samping</div>');
        } else {
            $("#id_ekstra").val(id);
            ...
            $.getJSON(base_url+"<?php echo $url; ?>/ambil_siswa/"+id, function(data) {
                ...
                html = '<table class="table table-bordered"><thead><tr><th width="10%" rowspan="2">No</th><th width="40%" rowspan="2">Nama</th><th width="50%" colspan="2">Nilai</th></tr></thead><tbody>';
                var i = 1;
                $.each(data.data, function(k, v) {
                    var pnilai = ["-","A","B","C"];
                    html += '<tr><td>'+i+'</td><td>'+v.nmsiswa+'</td><td style="display:none"><input name="id_siswa[]" type="hidden" value="'+v.ids+'"><select style="display:none" name="nilai[]" id="nilai_'+i+'" onchange="return ganti_deskripsi('+i+');" style="padding: 5px" class="form-control input-sm" required>';
