    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <a href="<?php echo base_url(); ?>n_keterampilan/uploadkd/<?php echo $detil_mp['id_mapel']."-".$detil_mp['id_kelas']; ?>" class="btn btn-success"><i class="fa fa-upload"></i> Upload KD</a>
                <a href="<?php echo base_url(); ?>n_keterampilan/import/<?php echo $detil_mp['id_mapel']."-".$detil_mp['id_kelas']; ?>" class="btn btn-danger" style=""><i class="fa fa-download"></i> Download File Excel</a>
